...
public class GuessNumber extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if(num == jTextField1.getText()){
           System.out.println(num + jTextField1.getText());
            JOptionPane.showMessageDialog(jButton1, "You Guessed Right");
            
        }else
         JOptionPane.showMessageDialog(jButton1, "You Guessed Wrong");
