...
public class JFrameAddMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtOutStandingBalance.setBackground(new java.awt.Color(255, 255, 255));
        txtOutStandingBalance.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtOutStandingBalance.setForeground(new java.awt.Color(0, 0, 0));
        ...
        txtCCAccountHolder.setBackground(new java.awt.Color(255, 255, 255));
        txtCCAccountHolder.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtCCAccountHolder.setForeground(new java.awt.Color(0, 0, 0));
        ...
        txtCreditCardNumber.setBackground(new java.awt.Color(255, 255, 255));
        txtCreditCardNumber.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtCreditCardNumber.setForeground(new java.awt.Color(0, 0, 0));
